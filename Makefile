...
UNREALROOTPATH = /home/vidb/EpicGames/UnrealEngine
GAMEPROJECTFILE =/home/vidb/Documents/UnrealProjects/Image2Pose/Image2Pose.uproject

TARGETS = \
	Image2Pose-Linux-Debug  \
	Image2Pose-Linux-DebugGame  \
	Image2Pose-Linux-Test  \
	Image2Pose-Linux-Shipping  \
	Image2Pose \
	Image2PoseEditor-Linux-Debug  \
	Image2PoseEditor-Linux-DebugGame  \
	Image2PoseEditor-Linux-Test  \
	Image2PoseEditor-Linux-Shipping  \
	Image2PoseEditor \
...
StandardSet: RequiredTools UnrealFrontend Image2PoseEditor UnrealInsights

DebugSet: RequiredTools UnrealFrontend-Linux-Debug Image2PoseEditor-Linux-Debug


Image2Pose-Linux-Debug:
	 $(PROJECTBUILD) Image2Pose Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Image2Pose-Linux-DebugGame:
	 $(PROJECTBUILD) Image2Pose Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Image2Pose-Linux-Test:
	 $(PROJECTBUILD) Image2Pose Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Image2Pose-Linux-Shipping:
	 $(PROJECTBUILD) Image2Pose Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Image2Pose:
	 $(PROJECTBUILD) Image2Pose Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

Image2PoseEditor-Linux-Debug:
	 $(PROJECTBUILD) Image2PoseEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Image2PoseEditor-Linux-DebugGame:
	 $(PROJECTBUILD) Image2PoseEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Image2PoseEditor-Linux-Test:
	 $(PROJECTBUILD) Image2PoseEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Image2PoseEditor-Linux-Shipping:
	 $(PROJECTBUILD) Image2PoseEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Image2PoseEditor:
	 $(PROJECTBUILD) Image2PoseEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
